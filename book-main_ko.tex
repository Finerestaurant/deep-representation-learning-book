...
% 한글 폰트 설정 - AppleMyungjo with fake italic/bold
...
\title{데이터 분포의 심층 표현 학습 \vspace{0.1in}\\
...
\subfile{chapters/preface/preface_ko.tex}
\cleardoublepage

\addcontentsline{toc}{chapter}{오픈소스 선언}
\subfile{chapters/declaration/declaration_ko.tex}
\cleardoublepage

\addcontentsline{toc}{chapter}{감사의 글}
\subfile{chapters/acknowledgment/acknowledgment_ko.tex}
\cleardoublepage

% \addcontentsline{toc}{chapter}{인공지능의 기여}
% \subfile{chapters/acknowledgment/AI_ko.tex}
% \cleardoublepage
...
\subfile{chapters/chapter1/introduction_ko}

\subfile{chapters/chapter2/classic-models_ko}

\subfile{chapters/chapter3/compression-principle_ko}

\subfile{chapters/chapter4/deep-networks_ko}

\subfile{chapters/chapter5/consistent_ko}
%\subfile{chapters/Chapter5-old/auto-encoding}

\subfile{chapters/chapter6/conditional_ko}

%\subfile{chapters/Chapter6-old/closed-loop}

\subfile{chapters/chapter7/applications_ko}

\subfile{chapters/chapter8/future_ko}
...
\subfile{chapters/appendixA/optimization_ko}

\subfile{chapters/appendixB/entropy_ko}
